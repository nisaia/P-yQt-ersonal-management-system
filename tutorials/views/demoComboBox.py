...
# Form implementation generated from reading ui file 'views/ui/demoComboBox.ui'
#
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.label.setGeometry(QtCore.QRect(20, 40, 251, 40))
        self.label.setObjectName("label")
        self.comboBoxAccountType = QtWidgets.QComboBox(Dialog)
        self.comboBoxAccountType.setGeometry(QtCore.QRect(280, 50, 281, 30))
        self.comboBoxAccountType.setStyleSheet("")
        ...
        self.labelAccountType.setGeometry(QtCore.QRect(0, 110, 600, 40))
