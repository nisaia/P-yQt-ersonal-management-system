...
class Ui_addBook_window(object):
    def setupUi(self, addBook_window):
        ...
        self.formLayout.setWidget(11, QtWidgets.QFormLayout.FieldRole, self.bookPreview_button)
        self.bookDescription_label = QtWidgets.QLabel(addBook_window)
        self.bookDescription_label.setObjectName("bookDescription_label")
        self.formLayout.setWidget(13, QtWidgets.QFormLayout.LabelRole, self.bookDescription_label)
        ...
        self.formLayout.setWidget(16, QtWidgets.QFormLayout.FieldRole, self.addBook_button_1)
        self.clearAll_button = QtWidgets.QPushButton(addBook_window)
        self.clearAll_button.setObjectName("clearAll_button")
        self.formLayout.setWidget(17, QtWidgets.QFormLayout.FieldRole, self.clearAll_button)
        self.bookYear_comboBox = QtWidgets.QComboBox(addBook_window)
        self.bookYear_comboBox.setObjectName("bookYear_comboBox")
        self.formLayout.setWidget(6, QtWidgets.QFormLayout.FieldRole, self.bookYear_comboBox)
    ...
    def retranslateUi(self, addBook_window):
        ...
        self.bookYear_label.setText(_translate("addBook_window", "Year:"))
