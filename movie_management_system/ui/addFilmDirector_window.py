...
class Ui_addFilmDirector_window(object):
    def setupUi(self, addFilmDirector_window):
        ...
        self.addFilmDirector_button = QtWidgets.QPushButton(addFilmDirector_window)
        self.addFilmDirector_button.setObjectName("addFilmDirector_button")
        self.formLayout.setWidget(5, QtWidgets.QFormLayout.FieldRole, self.addFilmDirector_button)
    ...
    def retranslateUi(self, addFilmDirector_window):
        ...
        self.addFilmDirector_button.setText(_translate("addFilmDirector_window", "Add film director"))
