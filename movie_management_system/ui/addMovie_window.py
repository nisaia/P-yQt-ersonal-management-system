...
class Ui_addMovie_window(object):
    def setupUi(self, addMovie_window):
        ...
        self.addMovie_button_1 = QtWidgets.QPushButton(addMovie_window)
        self.addMovie_button_1.setObjectName("addMovie_button_1")
        self.formLayout.setWidget(12, QtWidgets.QFormLayout.FieldRole, self.addMovie_button_1)
    ...
    def retranslateUi(self, addMovie_window):
        ...
        self.addMovie_button_1.setText(_translate("addMovie_window", "Add movie"))
