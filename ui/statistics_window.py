...
class Ui_statistics_window(object):
    def setupUi(self, statistics_window):
        ...
        self.genres_labes = QtWidgets.QLabel(statistics_window)
        self.genres_labes.setAlignment(QtCore.Qt.AlignCenter)
        self.genres_labes.setObjectName("genres_labes")
        self.gridLayout.addWidget(self.genres_labes, 0, 2, 1, 1)
        ...
        self.genres_counter_label = QtWidgets.QLabel(statistics_window)
        self.genres_counter_label.setText("")
        self.genres_counter_label.setAlignment(QtCore.Qt.AlignCenter)
        self.genres_counter_label.setObjectName("genres_counter_label")
        self.gridLayout.addWidget(self.genres_counter_label, 1, 2, 1, 1)
    ...
    def retranslateUi(self, statistics_window):
        ...
        self.genres_labes.setText(_translate("statistics_window", "Genres:"))
