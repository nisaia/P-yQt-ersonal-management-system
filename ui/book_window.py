...
class Ui_book_window(object):
    def setupUi(self, book_window):
        ...
        self.formLayout.setWidget(4, QtWidgets.QFormLayout.LabelRole, self.genre_label)
        self.genre_comboBox = QtWidgets.QComboBox(self.tab_2)
        self.genre_comboBox.setObjectName("genre_comboBox")
        self.formLayout.setWidget(4, QtWidgets.QFormLayout.FieldRole, self.genre_comboBox)
