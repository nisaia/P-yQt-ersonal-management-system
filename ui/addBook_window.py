...
class Ui_addBook_window(object):
    def setupUi(self, addBook_window):
        ...
        self.formLayout.setWidget(4, QtWidgets.QFormLayout.LabelRole, self.isbn_label)
        self.author_label = QtWidgets.QLabel(self.addBook_frame)
        self.author_label.setObjectName("author_label")
        self.formLayout.setWidget(6, QtWidgets.QFormLayout.LabelRole, self.author_label)
        self.genre_label = QtWidgets.QLabel(self.addBook_frame)
        self.genre_label.setObjectName("genre_label")
        self.formLayout.setWidget(8, QtWidgets.QFormLayout.LabelRole, self.genre_label)
        self.cover_label = QtWidgets.QLabel(self.addBook_frame)
        self.cover_label.setObjectName("cover_label")
        self.formLayout.setWidget(11, QtWidgets.QFormLayout.LabelRole, self.cover_label)
        ...
        self.formLayout.setWidget(4, QtWidgets.QFormLayout.FieldRole, self.isbn_lineEdit)
        self.author_comboBox = QtWidgets.QComboBox(self.addBook_frame)
        self.author_comboBox.setObjectName("author_comboBox")
        self.formLayout.setWidget(6, QtWidgets.QFormLayout.FieldRole, self.author_comboBox)
        self.genre_comboBox = QtWidgets.QComboBox(self.addBook_frame)
        self.genre_comboBox.setObjectName("genre_comboBox")
        self.formLayout.setWidget(8, QtWidgets.QFormLayout.FieldRole, self.genre_comboBox)
        ...
        self.formLayout.setWidget(11, QtWidgets.QFormLayout.FieldRole, self.uploadCover_button)
        self.preview_button = QtWidgets.QPushButton(self.addBook_frame)
        self.preview_button.setObjectName("preview_button")
        self.preview_button.setVisible(False)
        self.formLayout.setWidget(13, QtWidgets.QFormLayout.FieldRole, self.preview_button)
        self.description_label = QtWidgets.QLabel(self.addBook_frame)
        self.description_label.setObjectName("description_label")
        self.formLayout.setWidget(17, QtWidgets.QFormLayout.LabelRole, self.description_label)
        ...
        self.formLayout.setWidget(17, QtWidgets.QFormLayout.FieldRole, self.description_plainTextEdit)
        self.addBook_button = QtWidgets.QPushButton(self.addBook_frame)
        self.addBook_button.setObjectName("addBook_button")
        self.formLayout.setWidget(23, QtWidgets.QFormLayout.FieldRole, self.addBook_button)
        self.clearAll_button = QtWidgets.QPushButton(self.addBook_frame)
        self.clearAll_button.setObjectName("clearAll_button")
        self.formLayout.setWidget(24, QtWidgets.QFormLayout.FieldRole, self.clearAll_button)
        ...
        self.formLayout.setWidget(12, QtWidgets.QFormLayout.FieldRole, self.coverPath_label)
        spacerItem = QtWidgets.QSpacerItem(20, 40, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Preferred)
        self.formLayout.setItem(1, QtWidgets.QFormLayout.SpanningRole, spacerItem)
        spacerItem1 = QtWidgets.QSpacerItem(20, 40, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Preferred)
        self.formLayout.setItem(20, QtWidgets.QFormLayout.SpanningRole, spacerItem1)
    ...
    def retranslateUi(self, addBook_window):
        ...
        self.genre_label.setText(_translate("addBook_window", "Genre:"))
