...
class Ui_addBook_window(object):
    def setupUi(self, addBook_window):
        ...
        self.formLayout.setWidget(8, QtWidgets.QFormLayout.LabelRole, self.category_label)
        ...
        self.formLayout.setWidget(8, QtWidgets.QFormLayout.FieldRole, self.category_comboBox)
